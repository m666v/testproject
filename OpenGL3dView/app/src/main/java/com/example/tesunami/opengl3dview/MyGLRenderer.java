...
public class MyGLRenderer implements GLSurfaceView.Renderer {
    ...
    public void onDrawFrame(GL10 unused) {
        ...
        Matrix.setRotateM(mRotationMatrix, 0, 0, yAngle, zAngle, 1.0f);
        ...
        Matrix.setRotateM(mRotationMatrix, 0, xAngle, 0, 0, 1.0f);
    ...
    */
     ...
     */
    public void setCameraAngle(float xAngle ,float yAngle ,float zAngle){
        this.xAngle =xAngle;
        this.yAngle = yAngle;
        this.zAngle = zAngle;
    }
