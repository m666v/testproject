...
public class CubeShape extends GLShape {
    ...
    public CubeShape(ColorShader shader) {
        ...
        float[] vertices = new float[]{
                -0.1f,-0.3f,-0.5f,0,0,0,
                +0.1f,-0.3f,-0.5f,1,0,0,
                -0.1f,+0.3f,-0.5f,0,1,0,
                +0.1f,+0.3f,-0.5f,1,1,0,
                -0.1f,-0.3f,+0.5f,0,0,1,
                +0.1f,-0.3f,+0.5f,1,0,1,
                -0.1f,+0.3f,+0.5f,0,1,1,
                +0.1f,+0.3f,+0.5f,1,1,1
                };
