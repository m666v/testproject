...
public class CubeShape extends GLShape {
    ...
    public CubeShape(ColorShader shader) {
        ...
        float[] vertices = new float[]{
                -0.05f,-0.15f,-0.1f,0,0,0,
                +0.05f,-0.15f,-0.1f,1,0,0,
                -0.05f,+0.15f,-0.1f,0,1,0,
                +0.05f,+0.15f,-0.1f,1,1,0,
                -0.05f,-0.15f,+0.1f,0,0,1,
                +0.05f,-0.15f,+0.1f,1,0,1,
                -0.05f,+0.15f,+0.1f,0,1,1,
                +0.05f,+0.15f,+0.1f,1,1,1
                };
